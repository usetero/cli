...
// toastClearRequestedMsg dismisses the current toast.
type toastClearRequestedMsg struct{}
...
// clearAfter returns a command that sends toastClearRequestedMsg after the duration.
func clearAfter(d time.Duration) tea.Cmd {
	return tea.Tick(d, func(time.Time) tea.Msg {
		return toastClearRequestedMsg{}
	})
}
