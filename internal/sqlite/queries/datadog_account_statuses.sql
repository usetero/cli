...
SELECT
  ...
  SUM(current_total_usd_per_hour - impact_total_usd_per_hour) AS observed_cost_after,
  SUM(current_bytes_usd_per_hour - impact_bytes_usd_per_hour) AS observed_cost_after_bytes,
  SUM(current_volume_usd_per_hour - impact_volume_usd_per_hour) AS observed_cost_after_volume,
  SUM(current_events_per_hour) AS observed_volume_before,
  SUM(current_events_per_hour - impact_events_per_hour) AS observed_volume_after,
