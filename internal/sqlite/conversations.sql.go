...
SELECT id, account_id, created_at, updated_at, user_id, workspace_id FROM conversations WHERE id = ?
`
...
SELECT id, account_id, created_at, updated_at, user_id, workspace_id FROM conversations
WHERE account_id = ?
