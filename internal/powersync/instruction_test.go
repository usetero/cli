...
func TestInstruction_UnmarshalJSON(t *testing.T) {
	...
	t.Run("parses EstablishSyncStream", func(t *testing.T) {
		...
		var inst powersync.Instruction
		if err := json.Unmarshal([]byte(data), &inst); err != nil {
			t.Fatalf("Unmarshal error = %v", err)
		}

		if inst.Type != powersync.InstructionEstablishSyncStream {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionEstablishSyncStream)
		}
		if inst.Request == nil {
	...
	t.Run("parses FetchCredentials", func(t *testing.T) {
		...
		if inst.Type != powersync.InstructionFetchCredentials {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionFetchCredentials)
		}
	...
	t.Run("parses CloseSyncStream", func(t *testing.T) {
		...
		if inst.Type != powersync.InstructionCloseSyncStream {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionCloseSyncStream)
		}
	...
	t.Run("parses UpdateSyncStatus with realistic payload", func(t *testing.T) {
		...
		if inst.Type != powersync.InstructionUpdateSyncStatus {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionUpdateSyncStatus)
		}
	...
	t.Run("parses LogLine", func(t *testing.T) {
		...
		if inst.Type != powersync.InstructionLogLine {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionLogLine)
		}
	...
	t.Run("parses DidCompleteSync", func(t *testing.T) {
		...
		if inst.Type != powersync.InstructionDidCompleteSync {
			t.Errorf("Type = %q, want %q", inst.Type, powersync.InstructionDidCompleteSync)
		}
	})
